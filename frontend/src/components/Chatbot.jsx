...
import logo from "../assets/bot-logo.png"; // Path to your bot logo
...
function Chatbot({ originalText }) {
  ...
  const toggleChatbox = () => {
    setIsChatOpen(!isChatOpen); // Toggle the visibility of the chatbox
  };

  return (
    <>
      {/* Chatbot icon positioned at bottom-left */}
